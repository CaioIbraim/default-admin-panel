...
const AlunoForm: React.FC<AlunoFormProps> = ({ form, initialValues, onFinish }) => {
  ...
  const uploadImage = async (file: File) => {
    try {
      if (initialValues?.imagem_url) {
        await deletePreviousImage(initialValues.imagem_url); // Deleta a imagem anterior, se existir
      }
      ...
      form.setFieldsValue({ imagem_url: imageUrl }); // Atualiza o campo imagem_url no formulário
